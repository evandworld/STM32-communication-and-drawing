...
////////
 ...
 GPIO_InitStructure.GPIO_Pin = GPIO_Pin_2;	    		 //LED1-->PC.2 端口配置, 推挽输出
 GPIO_Init(GPIOC, &GPIO_InitStructure);	  				 //推挽输出 ，IO口速度为50MHz
 GPIO_ResetBits(GPIOC,GPIO_Pin_2); 						 //输出高 
	/////
...
GPIO_InitStructure.GPIO_Pin = GPIO_Pin_3;	    		 //LED1-->PC.3 端口配置, 推挽输出
 ...
 GPIO_InitStructure.GPIO_Pin = GPIO_Pin_5;	    		 //LED1-->PC.5 端口配置, 推挽输出
 GPIO_Init(GPIOC, &GPIO_InitStructure);	  				 //推挽输出 ，IO口速度为50MHz
